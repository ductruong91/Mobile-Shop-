...
<?php
		...
		// $count_arr = $query_count->fetch_assoc();
		// $count_prd = $count_arr[key($count_arr)];
		$count_prd = mysqli_num_rows(mysqli_query($con, "SELECT * FROM product"));
		// $sql_count = "SELECT COUNT(*) FROM user";
		// $query_count = mysqli_query($con, $sql_count);
		// $count_arr = $query_count->fetch_assoc();
		// $count_user = $count_arr[key($count_arr)];
		$count_user = mysqli_num_rows(mysqli_query($con, "SELECT * FROM user"));
		$count_comment = mysqli_num_rows(mysqli_query($con, "SELECT * FROM comment"));
?>
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?php echo $count_comment ?></div>

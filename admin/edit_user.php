...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Edit Thông Tin</li>
        </ol>
    </div>
    <!--/.row-->
                        ...
                        <form role="form" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="user_full" required class="form-control"
                                    value="<?php echo $cur_row['user_full'] ?>" placeholder="">
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                                <input type="text" name="user_mail" required value="<?php echo $cur_row['user_mail'] ?>"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="user_level" class="form-control">
                                    <option value=1 <?php if ($cur_row['user_level'] == 1) echo 'selected' ?>>Admin
                                    </option>
                                    <option value=2 <?php if ($cur_row['user_level'] == 2) echo 'selected' ?>>Member
                                    </option>
                                </select>
                            </div>

    ...
    <form method="post">
        ...
        <div class="cart-item row">
            ...
            <div class="cart-quantity col-lg-2 col-md-2 col-sm-12">
                <input type="number" id="quantity" name="quantity[<?php echo $row_prd['prd_id'] ?>]"
                    class="form-control form-blue quantity" value="<?php echo $value ?>" min="1">
            </div>
            <div class="cart-price col-lg-3 col-md-3 col-sm-12">
                <b><?php echo number_format($row_prd['prd_price'], 0, '', '.'); ?>đ</b><a
                    href="modules/cart/cart_del.php?id=<?php echo $row_prd['prd_id']; ?>">Xóa</a>
            </div>
        </div>
        <?php }
        } else { ?>
        ...
        <div class="row">
            ...
            <div class="cart-price col-lg-3 col-md-3 col-sm-12">
                <b><?php echo number_format($total_cash, 0, '', '.'); ?>đ</b>
            </div>
        </div>
    </form>
</div>
